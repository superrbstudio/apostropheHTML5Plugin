...
/**
 * THIS FILE IS CUSTOMIZED, please diff before replacing it with a newer version of
 * the upstream original. tom@punkave.com
 */
...
class qqFileUploader {
    ...
    function handleUpload($uploadDirectory, $replaceOldFile = FALSE){
        ...
        // tom@punkave.com: no funny business in filenames, we want them to 
        // be easy to throw around in quotes etc. and reduce hacking risks
        $filename = aTools::slugify($filename);
        //$filename = md5(uniqid());
